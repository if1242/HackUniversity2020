...
class ViewController: UIViewController, ARSCNViewDelegate, CLLocationManagerDelegate {
    ...
    private let mark: SCNSphere = {
        let sphere = SCNSphere(radius: 16)
    ...
    override func viewDidLoad() {
        ...
        statusTextView.textContainerInset = UIEdgeInsets(top: 30.0, left: 10.0, bottom: 10.0, right: 0.0)
    }
...
//        let channel = pusher.subscribe("private-channel")
        ...
        let latitude = 59.929469
        let longitude = 30.296656
        self.heading = 30.20022
    ...
    func updateLocation(_ latitude : Double, _ longitude : Double) {
        ...
        if self.modelNode == nil {
            ...
            let node = SCNNode()
            self.modelNode = SCNNode(geometry: mark)
